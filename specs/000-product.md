...
- Make tools, permissions, context, messages, providers, skills, sessions, MCPs and sandbox behavior explicit.
...
- Keep multi-agent simple enough to ensure internal use.
