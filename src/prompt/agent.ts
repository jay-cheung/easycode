...
const navigationAndCacheContract = [
  ...
  "- For code navigation, first check repo_map, then use find_definition or rg_search, then read_lines for the smallest relevant range. Use grep only as a fallback. Full-file read is forbidden except for files under 100 lines or when the exact edit range is already known.",
...
const buildModeProtocol = [
  ...
  "2. Follow the navigation and symbol-aware edit plan contracts before editing.",
