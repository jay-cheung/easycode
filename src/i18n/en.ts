...
export function buildEnglishCopy(): UiCopy {
  ...
  return {
    ...
    helpText: [
      ...
      "  /file <path>            attach a workspace file to the next prompt",
      "  /file clear             clear pending files",
      ...
      "  /model <name|reset>     switch model or reset to provider default",
      "  /provider <name>        switch provider (e.g. openai)",
      "  /max-tokens <n|reset>   set or reset the session token budget",
      "  /max-steps <n|reset>    set or reset the session step limit",
    ...
    slashError: (code) => ({
      ...
      file_requires_value: "/file requires a workspace file path",
      ...
      max_tokens_requires_value: "/max-tokens requires a positive number or reset",
      max_steps_requires_value: "/max-steps requires a positive number or reset",
    ...
    modelReset: "Model reset to provider default.",
    maxTokensSet: (value) => `Max tokens set to ${value}`,
    maxStepsSet: (value) => `Max steps set to ${value}`,
    ...
    pendingFilesCleared: "Pending files cleared.",
    fileAttached: (label) => `Attached file: ${label}`,
    ...
    welcomeCommandLines: [
      ...
      "   /provider  Change provider        /model     Change active model",
      "   /max-tokens Set token limit       /max-steps Set step limit",
      "   /skill     Manage skills",
      "   /image     Attach vision input    /file      Attach workspace files",
